...
def main() -> int:
    ...
    (AUDIT / "outcome_calibration.md").write_text(
        ...
        "The early-vs-late split is a single, small temporal comparison — "
        "shows the monitor works, not a statistically powered claim. On a live substrate this consumes real "
        "(decision, outcome) pairs from the chained ledger; the realized outcome "
        "must be verified ground truth, never the agent's own later judgment "
        "(feedback-loop guard).\n\n"
